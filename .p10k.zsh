#!/bin/zsh
#
# Generated by Powerlevel10k configuration wizard on 2020-05-14 at 18:59 CDT.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 32946.
# Wizard options: compatible, ascii, lean_8colors, 1 line, compact, concise,
...
() {
    ...
    typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=46
    ...
    typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=207
